...
class HomeController extends GetxController {
  ...
  HomeController() {
    ...
    if (connectivity == null) {
      String str = FirebaseService.auth.currentUser!.email.toString().replaceAll(".", "1");
          ...
          if (!await db.isRowExists(
            ...
            db
              ...
              TaskModel(
                  ...
                  taskPriority: element.child('periority').value.toString(),
  ...
  popupMenuSelected(int value, int index, BuildContext context) async {
    if (value == 2) {
      Utils().showWarningDialog(context, () => removeFromList(index));
    }
  }
  ...
  removeFromList(int index) {
    db
        .removeFromList(TaskModel(
            ...
            taskPriority: list[index].taskPriority,
